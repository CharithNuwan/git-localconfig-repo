...
* The original package name 'com.charitha.config. spring-cloud-config-server' is invalid and this project uses 'com.charitha.config.springcloudconfigserver' instead.
